...
const colorpicker = extendContent(Block, "colorpicker", {
  ...
  buildConfiguration(tile, table){
    //var entity = tile.ent(); 
    //js-fy this at home
    table.addImageButton(Icon.pencil, () => { Vars.ui.picker.show(Tmp.c1.set(t.global.colors.brushcolor), false, res => { t.global.colors.brushcolor = res.rgba(); }); Vars.control.input.frag.config.hideConfig(); }).size(40); 
  },
