...
const overDome = extendContent(OverdriveProjector, "overdrive-dome", {
  draw(tile){
    ...
    Draw.color(this.baseColor, this.phaseColor, entity.getPhaseHeat());
  ...
  update(tile){
    ...
    var entity = tile.ent();
    entity.setHeat(Mathf.lerpDelta(entity.getHeat(), (entity.cons.valid() || tile.isEnemyCheat())? 1 : 0, 0.08));
    entity.setPhaseHeat(Mathf.lerpDelta(entity.getPhaseHeat(), Mathf.num(entity.cons.optionalValid()), 0.1));
  }
});
