...
const explosive = extendContent(Block, "explosive", {
  ...
  mineTile(tile, other, dist){
    ...
    var acceptTile = Units.findAllyTile(tile.getTeam(), tile.worldx(), tile.worldy(), 80, boolf(e=>(e.block().itemCapacity > 5 && !(e.block() instanceof Conveyor) && e.block().acceptStack(drops, amount, e, null) >= 1)));
