...
const fireitem = ["copper", "plastanium", "surge-alloy", "lead", "pyratite", "silicon", "commandblocks-ore-scalar", "commandblocks-ore-vector", "commandblocks-ore-zeta", "commandblocks-piece-code", "scrap", "commandblocks-bittrium", "commandblocks-log-binary", "commandblocks-log-redblack"];
const firecolor = [Color.valueOf("66ffbf"), Pal.plastanium, Pal.surge, Color.valueOf("c2fcff"), Pal.lightPyraFlame, Color.white, Color.valueOf("f5ddf3"), Color.valueOf("cfddff"), Color.valueOf("82ffe8"), Color.valueOf("5eff79"), Color.valueOf("ff4a80"), Color.valueOf("00ffff"), Color.valueOf("ffffaa"), Color.valueOf("ffbbbb")];
...
const campfire=extendContent(Block, "campfire",{
  ...
  spawnFire(tile){
    ...
    if(index > -1){
      ...
      this.color2 = firecolor[index].cpy().mul(0.7, 0.65, 0.65, 1);
    }
