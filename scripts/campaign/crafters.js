...
const codecrafter = extendContent(GenericSmelter, "codecrafter", {
  ...
  draw(tile){
    ...
    Lines.lineAngleCenter(tile.drawx() + Mathf.sin(entity.progress*6.282, 1, Vars.tilesize / 2 * this.size - 2)/2,tile.drawy(), 90, this.size * Vars.tilesize - Vars.tilesize * 1.6);
    Draw.reset();
